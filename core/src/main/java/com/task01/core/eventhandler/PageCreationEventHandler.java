...
public class PageCreationEventHandler implements EventHandler {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(PageCreationEventHandler.class);
    private static final String SERVICE_USER = "workflow-service-user";
    private static final String WORKFLOW_MODEL_PATH = "/var/workflow/models/page-expiry-workflow0"; // Temporarily use /var
